...
import com.nino.codilitytask3tmdb.ui.filter.FilterBottomSheetContent
import com.nino.codilitytask3tmdb.ui.filter.FilterHeader
import com.nino.codilitytask3tmdb.ui.filter.FilterViewModel
import com.nino.codilitytask3tmdb.ui.main.LocalDarkTheme
import com.nino.codilitytask3tmdb.ui.settings.SettingsContent
        ...
        topBar = {
            Surface(modifier = Modifier.fillMaxWidth(), elevation = 16.dp) {
                Column(
                    ...
                    AppAppBar(onSettingsClicked = { showSettingsDialog = true })
...
@Composable
private fun AppAppBar(onSettingsClicked: () -> Unit) {
